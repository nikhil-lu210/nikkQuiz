...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedTheme = localStorage.getItem('nikkQuizTheme');
    if (savedTheme === 'light') {
    ...
    toggleBtn.innerHTML = getIconHTML();
    
    toggleBtn.addEventListener('click', () => {
        document.body.classList.toggle('light-mode');
        const isLight = document.body.classList.contains('light-mode');
        localStorage.setItem('nikkQuizTheme', isLight ? 'light' : 'dark');
        toggleBtn.innerHTML = getIconHTML();
    });
...
function getIconHTML() {
    const isLight = document.body.classList.contains('light-mode');
    if (isLight) {
        // Moon icon for dark mode enable
        ...
        // Sun icon for light mode enable
